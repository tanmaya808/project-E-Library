...
gotoxy(16,6);
printf("\tGuided by :Rajasree Patel ");
gotoxy(30,7);
printf("\tand");
gotoxy(16,8);
printf("\tBrought to you by");
gotoxy(0,10);
printf("\tSiba prasad,Tanmaya kumar,Soubhagya,Sidhartha,Sudipta,Suryakanta");
gotoxy(16,11);
printf("\tNayagarh auto. college,Nayagarh");
gotoxy(16,12);
printf("*******************************************");
gotoxy(10,15);
printf("Exiting in 3 second...........> if not exit please press enter");
Sleep(3000);
exit(0);
}
default:
...
gotoxy(20,7);
printf("\xDB\xDB\xDB\xDB\xB2 1. CS");
gotoxy(20,9);
printf("\xDB\xDB\xDB\xDB\xB2 2. ITM");
gotoxy(20,19);
...
fclose(fp);
remove("Proj.dat");
rename("test.dat","Proj.dat"); //copy all item from temporary file to fp except that
fp=fopen("Proj.dat","rb+");    //we want to delete
if(findbook=='t')
{
gotoxy(10,10);
...
gotoxy( 15,20);
printf("Enter Your Choice");
fp=fopen("Proj.dat","rb+"); //open file for reading propose
